...
OVERRIDES = {
    ...
    # [PHOTO 20260812_141158.jpg, photo-02] the lounge ottoman is upholstered
    # in a navy and cream triangle tessellation, not the exhibit's grey and
    # white lattice.  Generated by textures/ottoman.py at true scale.
    'ottoman': {'textures': 'ottoman'},
    # [PHOTO 20260812_141158.jpg, photo-02] the base along the mirror wall and
    # the entry partition is a dark cove base, (56, 51, 43) sRGB at the foot of
    # a wall that reads (165, 165, 163) beside it; the exhibit's #dedad1 is a
    # light paint.  Albedo SCALED from that ratio.
    'inl-dedad1-r55-m0': {'base_color': (0.040, 0.035, 0.028)},
    # [PHOTO 20260812_141158.jpg, photo-02] the sofa is a charcoal tweed that
    # reads (29, 29, 30) sRGB on its back and (21, 20, 21) on the arm while
    # the exhibit's map rendered (119, 119, 114) and (57, 57, 57) in the same
    # patches at an exposure 0.7 stops over the photograph: 2.6 stops darker
    # after that exposure is taken out, a hair warm.
    'tweed': {'tint': (0.17, 0.16, 0.16)},
    # [PHOTO 20260812_141158.jpg, photo-02] the car print is a dark monochrome
    # photograph, (87, 82, 79) sRGB across the grille, not the exhibit's pale
    # grey drawing, which rendered (203, 200, 192): 1.9 stops darker after
    # the same exposure correction.
    'inl-ffffff-r55-m0-carPrint': {'tint': (0.28, 0.27, 0.27)},

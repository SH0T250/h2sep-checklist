...
await p.evaluate((rs)=>{const db=JSON.parse(localStorage.getItem('h2sep-demo-db-v1'));Object.assign(db.rooms,rs);localStorage.setItem('h2sep-demo-db-v1',JSON.stringify(db));},rooms);
